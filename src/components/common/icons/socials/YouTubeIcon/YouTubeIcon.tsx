interface YouTubeIconProps extends React.ComponentProps<'svg'> {}

export const YouTubeIcon: React.FC<YouTubeIconProps> = (props) => (
  <svg
    {...props}
    aria-labelledby='ak48wm4fj0is7ssc6dzw8ftl09y6s39q'
    fill='none'
    height='16'
    role='img'
    viewBox='0 0 16 16'
